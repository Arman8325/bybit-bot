# Полный обновлённый код Telegram-бота с:
# ✅ Кнопками таймфрейма (15м, 30м, 1ч)
# ✅ Сигналом /verify, /accuracy
# ✅ Автообновлением прогноза каждые 15 минут
# ✅ Хранением истории в SQLite
...
def auto_update_forecast():
    while True:
        try:
            ...
            process_signal(chat_id, "15")
        except Exception as e:
            print(f"[!] Auto update error: {e}")
        time.sleep(900)  # каждые 15 минут

# Фоновый автоапдейт
threading.Thread(target=auto_update_forecast, daemon=True).start()
